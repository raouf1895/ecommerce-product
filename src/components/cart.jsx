  ...
  return (
    <div className=' flex justify-center items-center  mobile:h-[140px] h-[150px] '>  
        { context.added &&  <div className='flex gap-3 flex-wrap justify-center items-center'>
               ...
               <button className='h-[50px] mobile:px-0 mobile:w-[300px] px-[32vw] bg-my-orange rounded-lg font-my-font text-White hover:opacity-70'>Checkout</button>
           </div>}
           {!context.added && <h3 className='mobile:px-0 px-[30vw]  text-center  '>Your cart is empty</h3>}
    </div>
